...
| **5400** | ⏳ PLANNED — Survey (architect brief E6) | provider capability/routing research layer: dated sources, per-provider profiles, Arena uncertainty discipline — non-boot | — |
