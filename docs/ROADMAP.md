...
| **RD-3** | ✅ DELIVERED — RD-3 SILENCE RECONCILIATION + INCIDENT CHAIN CLOSURE LAWS base fee4a95 | docs/.readme §8.4 M read-only + AGENTS.md M read-only + CUE-SILENCE-CONSENT v2 read-only effects require II.11 + CUE_INDEX/CUE_SYSTEM/AI_RULES/proc_scan-declaration M + lexicon/autopilot-cues M + release_truth_check.py LAW-1 PUBLIC-OBJECT + LAW-3 DELTA-≡-ALLOWED + 3 new self-test vectors 11 total + workflow label 7→11 + memo postmortem 08-overhaul/MEMO_POSTMORTEM_gate-chain-2026-09-16.md + ledger honesty #75-#81 incident chain | Commander directive INCIDENT CHAIN CLOSING + RD-3 order 2026-09-16 base fee4a95 sealed PR #2 run #81 green, 4 laws, 96 unittest, 11/11 self-test, delta-vs-allowed ∅, public-object ancestor origin/main | v3.10.11 | 2026-09-16 |
| **P-12** | ✅ DELIVERED — Post-Incident Hygiene & Motor-Preflight (LAW-5) | scripts/push_preflight_check.py A LAW-5 BASE-PIN HEAD==base verify-the-face + PUBLIC-OBJECT base ancestor origin/main + DELTA-≡-ALLOWED diff≡allowed + CI-HYGIENE _output.txt→FAIL + tests/test_push_preflight.py A 5 vectors happy/wrong-HEAD/extra-diff/extra-allowed/hygiene + docs/WARN_LEDGER.md A WARN census audit 4→3 (11.6 replica OPEN GOVERNED EXCEPTION accepted, 15 boot-byte accepted, 16 meta-budget accepted, 20.5 planner theater fixed via attempt row) + docs/RELEASE_TRUTH_GATE/README.md M motor preflight section + docs/CUE_SYSTEM.md M cross-link + tools/TOOL_REGISTRY.json M 25 tools + CAPABILITIES/SYSTEM_STATE GENERATED + 4 laws + LAW-5 enforced, 101 unittest 11/11 self-test 5/5 preflight, delta-vs-allowed ∅, public-object ancestor origin/main, attempt: fixes 20.5 | Commander directive P-12 Post-Incident Hygiene & Motor-Preflight base 0c0548b19e7bb3ddc1c8ff83ee5e3e5105959aef sealed, run #82 stale-base extraction + hand merge closed | v3.10.12 | 2026-09-16 |
| **P-13** | ✅ DELIVERED — Phase-A Loose Ends: G1 ICS dates + G2 ingest caps | scripts/ics_normalize.py M G1 RDATE comma-split mirror EXDATE + 4 new vectors 29/29 self-test (single-date unchanged + desk repro 20261008T090000,20261015T090000 parses 2 dates) + scripts/ingest_collection.py M G2 default cap 10 MiB unless --max-size override + streamed byte count abort+finding regardless manifest size + tests/test_ingest_collection.py A 4 vectors under-cap ok/over-cap streamed abort without manifest size/override honored/default cap 10 + tools/TOOL_REGISTRY.json M description gains default cap fact 25 tools 15/15 + 105 unittest 11/11 self-test 5/5 preflight 29/29 ics, delta-vs-allowed ∅, public-object ancestor origin/main, G3 CLOSED by RD-3 silence=read-only v2 | Commander directive P-13 Phase-A Loose Ends base f24612e460bf32e27aa01a1db962491b355fd000 sealed P-12 | v3.10.13 | 2026-09-16 |
| **P-14** | ✅ DELIVERED — Brain Retrieval Lattice (G5): corpus behavior from absence to mechanism | Brain/MEMORY_CATALOG.jsonl A 24 entries sorted id unique ≥20 covering 8 corpus derivatives + frontal-lobe ledgers + short-term plan + shrine log + cue Brain/ + schemas/memory_catalog_entry.schema.json A + scripts/brain_retrieve.py A deterministic selector law tokenize [a-z0-9]+ score=3*tags+2*title+1*path abstention <4 ranked score desc id asc evidence-only II.11 modes --query/--cases/--self-test 8 vectors + evals/brain/retrieval_cases.json A 15 cases 10 known-hit exact order including 2 multi-hit ranked + 4 abstention [] + 1 determinism duplicate + tests/test_brain_retrieval.py A 6 vectors + tools/TOOL_REGISTRY.json M 25→26 brain_retrieve mutation none network none + 111 unittest 11/11 self-test 5/5 preflight 29/29 ics 8/8 brain 15/15 cases, delta-vs-allowed ∅, public-object ancestor origin/main, G3 CLOSED by RD-3 | Commander directive P-14 Brain Retrieval Lattice G5 base 1e7b287a50cf7709f2cdb9bf50181b1816119516 | v3.10.14 | 2026-09-16 |
| **P-15** | ✅ DELIVERED — Docs Lanes (G6): the last fail-cell | docs/INDEX.md A four Diátaxis lanes Tutorial/How-to/Reference/Explanation + Generated sub-lane 36 docs assigned exactly once task+audience + START_HERE.md A newcomer one-pass ≤10 steps clone→validate→PROTOCOL skim→BOOT_SEQUENCE walk→layer tour docs/INDEX.md→health trio + scripts/docs_index_check.py A deterministic stdlib checker house finding style (i) every relative md link in START_HERE README AGENTS PROTOCOL INDEX docs/*.md resolves skip http tolerate anchors (ii) every docs/*.md listed in INDEX or whitelist (iii) INDEX lists only existing --self-test 5 vectors broken link caught·orphan caught·whitelist honored·URL skip·INDEX lists only existing live 0 + tests/test_docs_index.py A 4 vectors check passes/INDEX coverage/self-test/Generated honest + tools/TOOL_REGISTRY.json M 26→27 docs_index_check mutation none network false 15/15 + schemas/memory_catalog_entry.schema.json M rider MEM-shrine-log deliberate outer-corpus pointer docs/shrine/LOG.md + 115 unittest 11/11 self-test 5/5 preflight 29/29 ics 15/15 cases 8/8 brain 5/5 docs 0 findings, delta-vs-allowed ∅, public-object ancestor origin/main, G6 CLOSED virtual lanes only | Commander directive P-15 Docs Lanes G6 base 094262db3ce5c9ed1460ff652f4d07bd28907261: last fail-cell G6 no newcomer one-pass no task-first lanes no link-check harness virtual lanes only links never moves zero relocations | v3.10.15 | 2026-09-16 |
| **P-16** | ✅ DELIVERED — Scaffolding Contract Spine (Dim-3/G4) | scaffolding/**/*.contract.json A 112 sidecars per scaffold file id SCAFFOLD-<kind>-<slug> kind core|neuron|membrane|other status active|draft|deprecated loads_when|null depends_on[] effects[] tests[] note? superseded_by? + schemas/scaffold_contract.schema.json A radiation.scaffold_contract/1 id pattern kind/status enums unique ids file-must-exist + scripts/scaffold_check.py A deterministic compile check house finding style sidecar valid vs schema + depends_on resolves + *.md/*.json has sidecar or whitelisted + deprecated superseded_by + draft note + no cycles --self-test 6 vectors valid/broken depends_on FAIL/uncontracted FAIL/cycle FAIL/deprecated missing superseded_by/draft missing note live 0 + tests/test_scaffold_check.py A 5 vectors live passes/broken depends_on FAIL/uncontracted FAIL/cycle FAIL/self-test + tools/TOOL_REGISTRY.json M 27→28 scaffold_check mutation none network false 15/15 + 120 unittest 11/11 self-test 5/5 preflight 29/29 ics 15/15 cases 8/8 brain 0 findings docs 0 findings scaffold 0 findings 6/6 self-test, delta-vs-allowed ∅, public-object ancestor origin/main, G4 CLOSED tooling-first | Commander directive P-16 Scaffolding Contract Spine base af578886ba70d63400d26490e87277718fbaf20a: scaffold files get typed sidecar contracts + deterministic compile check tooling-first same shape as P-14/P-15 | v3.10.16 | 2026-09-16 |
| **P-17** | ✅ DELIVERED — Skill Catalog Spine (Dim-7/G4) | skills/SKILL_CATALOG.json A 23 entries id SKILL-NNN title entry_path kind agent|procedure description ≤200 eval_ref status active|declared|deprecated activation_note pinned|asserted tests[] note? superseded_by? seeds ≥8 all found 5 provider +9 subskill +9 pipeline + schemas/skill_card.schema.json A radiation.skill_card/1 + evals/skills/ A 23 smoke fixtures + scripts/skill_check.py A deterministic house finding style catalog valid vs schema entry_path/eval_ref resolves unique ids status discipline no eval-free active --self-test 8 vectors repo passes/broken eval_ref FAIL/eval-free active FAIL/unknown status FAIL/duplicate id/declared missing note/deprecated missing superseded_by/entry_path missing live 0 + tests/test_skill_check.py A 5 vectors live passes/broken eval_ref FAIL/eval-free active FAIL/unknown status FAIL/self-test + tools/TOOL_REGISTRY.json M 28→29 skill_check mutation none network false 15/15 + 125 unittest 11/11 self-test 5/5 preflight 29/29 ics 15/15 cases 8/8 brain 0 findings docs 0 findings scaffold 0 findings skill 0 findings 8/8 self-test, delta-vs-allowed ∅, public-object ancestor origin/main, G4 CLOSED tooling-first | Commander directive P-17 Skill Catalog Spine base 0de224d58a758a5ee0b9278427ec224f1139ebdc: skills become typed schema-checked records with eval pointer per skill | v3.10.17 | 2026-09-16 |
| **P-18** | ✅ DELIVERED — Subskill Catalog + Hook Protocol (Dim-8/G4) | subskills/SUBSKILL_CATALOG.json A 9 entries id SUB-NNN title parent_skill FK→SKILL_CATALOG entry_path trigger before_skill|after_skill|on_event|manual condition|null description ≤200 scenario_ref status active|declared|deprecated tests[] + schemas/subskill_card.schema.json A radiation.subskill_card/1 + subskills/HOOK_PROTOCOL.md A declaration-only hooks invocation skill→subskill evidence capture no self-mod no network no elevation II.11 + evals/subskills/ A 9 scenarios trigger input sketch expected fire/non-fire + scripts/subskill_check.py A deterministic house finding style schema valid parent_skill FK resolves scenario_ref resolves trigger enum valid status discipline --self-test 8 vectors repo passes/broken parent FK FAIL/missing scenario_ref FAIL/illegal trigger FAIL/duplicate id/declared missing note/deprecated missing superseded_by/entry_path missing live 0 + tests/test_subskill_check.py A 5 vectors live passes/broken parent FK FAIL/missing scenario_ref FAIL/illegal trigger FAIL/self-test + tools/TOOL_REGISTRY.json M 29→30 subskill_check + 130 unittest 11/11 self-test 5/5 preflight 29/29 ics 15/15 cases 8/8 brain 0 findings docs 0 findings scaffold 0 findings skill 0 findings subskill 0 findings 8/8 self-test, delta-vs-allowed ∅, public-object ancestor origin/main, G4 CLOSED tooling-first | Commander directive P-18 Subskill Catalog + Hook Protocol base 12dfc22ed50007deb4399162e69f5540e90a89c3: subskills become typed records hooks declared machine-checked never-autonomous | v3.10.18 | 2026-09-16 |
| **P-19** | ✅ DELIVERED — Agent Contracts catalog (Dim-1/G4) | agents/contracts/ A 5 entries id AGT-<slug> provider profile_ref→CAPABILITY_PROFILE.md capabilities[] {claim ≤200 tier primary/secondary/asserted/benchmark receipt_ref/null} boundary_note model≠host separation authority {no_simulated_commander_authority true D4} status active/draft/deprecated tests[] + schemas/agent_contract.schema.json A radiation.agent_contract/1 + scripts/agent_contract_check.py A deterministic house finding style schema valid profile_ref resolves tier enum valid authority D4 exactly true unique ids status discipline --self-test 8 vectors repo passes/broken profile_ref FAIL/unknown tier FAIL/simulated-authority FAIL/duplicate id/draft missing note/deprecated missing superseded_by/claim too long live 0 + tests/test_agent_contract_check.py A 5 vectors live passes/broken profile_ref FAIL/unknown tier FAIL/simulated-authority FAIL/self-test + tools/TOOL_REGISTRY.json M 30→31 agent_contract_check + 135 unittest 11/11 self-test 5/5 preflight 29/29 ics 15/15 cases 8/8 brain 0 findings docs 0 findings scaffold 0 findings skill 0 findings subskill 0 findings agent_contract 0 findings 8/8 self-test, delta-vs-allowed ∅, public-object ancestor origin/main, G4 CLOSED tooling-first | Commander directive P-19 Agent Contracts catalog base ce37b7003ca2af912eeebcc53faf4f851b404f88: providers get typed contracts bounded by receipts D4 law machine-checked | v3.10.19 | 2026-09-16 |
