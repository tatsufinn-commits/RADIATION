...
| **5824** | ✅ DELIVERED — Release Truth Gate (compact non-boot) | base fbce71b first green after 5810-5822 (14 records 0 findings 24/24 39/3/0 25 OK strict PASS Actions success); EXPECTATION.json pins base SHA + allowed A/M/D incl required deletions + generated artifacts + mandatory validations + risks; checker scripts/release_truth_check.py fails on wrong base, file still on disk, delete missing from diff, undeclared path, stale artifact, missing DoD outcome (6 negative +1 positive 7/7); DoD template + risk register + post-push receipt template; scope locks non-boot concise no model records/sources/policy/profile/runtime/provider/evaluation/routing/deployment/legal, no auto push/apply/provider, Commander authority unchanged | Commander + acceptance fbce71b greenlight | prevents wrong-root, stale-base, ZIP-without-deletion, generated-drift, doc-claiming-unverified-CI, host/provider/surface confusion, unavailable credentials | v3.10.7 | 2026-09-15 |
