...
## REPOSITORY VERSION
**RADIATION v3.10.36** — T2:B named-function tests (all four live cue_resolver functions). Base 0438820441a8bfef3fb7ff8070cce857fd840ee8. No construct_from_card. Will courier read-only, not T3.
