...
**Last updated:** 2026-09-17 · **Version:** v3.10.29
...
**Machine facts (GENERATED — hand edits here are a CI failure; source: render_docs.py):** 42 validator checks · knowledge locks 11/16 (5 pending) · 46 K-IDs · Core 2/2 cards canonical · registry 13 directives · subskills 4 passive + 5 active · scripts 34 (12 exercised in CI)
